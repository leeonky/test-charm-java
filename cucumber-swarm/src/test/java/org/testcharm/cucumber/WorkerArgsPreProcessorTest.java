...
class WorkerArgsPreProcessorTest {
    ...
    class ForceSingleThread {
        ...
        void has_thread_arg() {
            ...
            expect(buildOptions(result.workerArgs)).should("threads: 1");
        }
    ...
    class WorkerPluginsNoSummaryHasForwarding {
        ...
        void has_no_summary_arg() {
            ...
            expect(buildOptions(result.workerArgs)).should("plugins: [{pluginString: org.testcharm.cucumber.swarm.WorkerForwardingPlugin}]");
        }
