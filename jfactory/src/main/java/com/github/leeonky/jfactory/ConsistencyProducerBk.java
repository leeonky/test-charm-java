...
@Deprecated
public class ConsistencyProducerBk<T> extends Producer<T> {
    private final Producer<T> originProducer;
    private final int index;
    private final List<DecomposerExecutor<T>> decomposerExecutors = new ArrayList<>();

    public ConsistencyProducerBk(Producer<T> originProducer, int index, DecomposerExecutor<T> decomposerExecutor) {
