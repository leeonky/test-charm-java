Feature: Define Spec in Different Object Creation Forms
  ...
  Scenario: Type Creation - Define Spec in Type Factory
  ...
  Scenario: Type Creation with Global Spec Class - Define Spec in Type Factory, Global Spec Class and Global Spec Factory
  ...
  Scenario: Spec Creation - Define Spec in Type Factory, Spec Class and Spec Factory
    Given the following spec definition:
      """
  ...
  Scenario: Spec Creation with Global Spec Class - Define Spec in Type Factory, Spec Class, Spec Factory, Global Spec Class and Global Spec Factory
    Given the following bean definition:
      """
      public class Bean {
        public String value1, value2, value3, value4, value5;
