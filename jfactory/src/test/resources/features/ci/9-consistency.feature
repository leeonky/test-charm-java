Feature: consistency
  ...
  Rule: merge consistency
    ...
    Scenario: merge with the same consistency type and merge compose and decompose
      Given the following bean class:
        """
        public class Bean {
          public String str1, str2, str3;
    ...
    Scenario: merge with the same consistency type and merge decompose and compose
      Given the following bean class:
        """
        public class Bean {
          public String str1, str2, str3;
