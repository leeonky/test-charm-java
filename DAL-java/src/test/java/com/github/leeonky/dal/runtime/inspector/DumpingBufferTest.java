...
class DumpingBufferTest {
    ...
    public static class BeanDumper implements Dumper {
        @Override
        public void dump(Data.Resolved data, DumpingBuffer dumpingBuffer) {
    ...
    void ignore_dump_error() {
        ...
        assertThat(context.wrap(new Bean()).dump()).isEqualTo("*throw* java.lang.RuntimeException: dump error");
    }
}