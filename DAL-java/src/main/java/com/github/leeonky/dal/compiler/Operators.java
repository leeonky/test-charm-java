...
public class Operators {
    ...
    static final OperatorParser<DALRuntimeContext, DALNode, DALOperator, DALProcedure, DALExpression>
            ...
            BINARY_ARITHMETIC_OPERATORS = oneOf(
                    ...
                    PLUS.operator(() -> plusSub(PLUS, Calculator::arithmetic, com.github.leeonky.dal.runtime.Operators.PLUS)),
                    SUBTRACTION.operator(() -> plusSub(SUBTRACTION, Calculator::arithmetic, com.github.leeonky.dal.runtime.Operators.SUB)),
                    MULTIPLICATION.operator(() -> mulDiv(MULTIPLICATION, Calculator::arithmetic, com.github.leeonky.dal.runtime.Operators.MUL)),
                    DIVISION.operator(() -> mulDiv(DIVISION, Calculator::arithmetic, com.github.leeonky.dal.runtime.Operators.DIV))),
