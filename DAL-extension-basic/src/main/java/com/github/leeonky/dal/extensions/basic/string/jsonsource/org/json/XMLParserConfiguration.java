...
//    public static final int DEFAULT_MAXIMUM_NESTING_DEPTH = 512; // We could override
    ...
    public XMLParserConfiguration() {
        ...
        convertNilAttributeToNull = false;
        xsiTypeMap = Collections.emptyMap();
    ...
    protected XMLParserConfiguration clone() {
        ...
        config.shouldTrimWhiteSpace = shouldTrimWhiteSpace;
        return config;
    }
    ...
    public XMLParserConfiguration withCloseEmptyTag(boolean closeEmptyTag) {
        XMLParserConfiguration clonedConfiguration = clone();
